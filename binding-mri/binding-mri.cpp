...
static void mriBindingExecute()
{
	...
	char options_argv1[] = "oneshot", options_argv2[] = "--jit" options_argv3[] = "-e", options_argv4[] = "";
	char* options_argv[] = {options_argv1, options_argv2, options_argv3, options_argv4, NULL};
	ruby_options(5, options_argv);
