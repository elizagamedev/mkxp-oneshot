...
RB_METHOD(rb_aleffect_EAXReverb_createUnderlyingEffect) {
	...
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_DIFFUSION, diffusion)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_DENSITY, density)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_GAIN, gain)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_GAINHF, gainhf)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_GAINLF, gainlf)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_DECAY_TIME, decay_time)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_DECAY_HFRATIO, decay_hfratio)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_DECAY_LFRATIO, decay_lfratio)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_REFLECTIONS_GAIN, reflections_gain)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_REFLECTIONS_DELAY, reflections_delay)
	ALEFFECT_SET_ATTRIBUTE_FLOAT3(AL_EAXREVERB_DEFAULT_REFLECTIONS_PAN_XYZ, reflections_pan)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_LATE_REVERB_GAIN, late_reverb_gain)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_LATE_REVERB_DELAY, late_reverb_delay)
	ALEFFECT_SET_ATTRIBUTE_FLOAT3(AL_EAXREVERB_DEFAULT_LATE_REVERB_PAN_XYZ, late_reverb_pan)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_ECHO_TIME, echo_time)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_ECHO_DEPTH, echo_depth)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_MODULATION_TIME, modulation_time)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_MODULATION_DEPTH, modulation_depth)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_AIR_ABSORPTION_GAINHF, air_absorption_gainhf)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_HFREFERENCE, hfreference)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_LFREFERENCE, lfreference)
	ALEFFECT_SET_ATTRIBUTE_FLOAT(AL_EAXREVERB_DEFAULT_ROOM_ROLLOFF_FACTOR, room_rolloff_factor)
	ALEFFECT_SET_ATTRIBUTE_INT(AL_EAXREVERB_DEFAULT_DECAY_HFLIMIT, decay_hflimit)
	return INT2NUM(id);
}
...
#define ALEFFECT_DEFINE_PRESET(preset, name) \
	RB_METHOD(rb_aleffect_EAXReverb_load_preset_##name) { \
		...
		EFXEAXREVERBPROPERTIES properties = preset; \
			ALEFFECT_SET_PRESET_FLOAT(diffusion, properties.flDensity) \
			ALEFFECT_SET_PRESET_FLOAT(density, properties.flDiffusion) \
